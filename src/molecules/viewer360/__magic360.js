...
var Magic360 = (function() {
    ...
    var m = function() {
        return "mgctlbxN$M360 mgctlbxV$" + "v4.6.8".replace("v", "") + " mgctlbxL$" + "t".toUpperCase() + ((window.mgctlbx$Pltm && "string" == u.jTypeOf(window.mgctlbx$Pltm)) ? " mgctlbxP$" + window.mgctlbx$Pltm.toLowerCase() : "")
    };
    var j = f([]);
    var o = {
        version: "v4.6.8 DEMO",
